 ...
 */
public class  EntityGeneratorDecorator extends GeneratorDecorator {

    private static final Logger LOG = LoggerFactory.getLogger(EntityGeneratorDecorator.class);

    public EntityGeneratorDecorator(Generator generator) {
        super(generator);
    }
